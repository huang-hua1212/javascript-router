  ...
  Router = class {
    ...
    navigate(t = {}) {
      ...
      if (this.mode === 'history') {
        window.history.pushState(null, null, this.root + Router.clearSlashes(e));
      } else {
    ...
    listen() {
      clearInterval(this.interval),
        (this.interval = setInterval(this.watchUrl, 60));
    }
    watchUrl() {
      ...
      for (let t of this.routes) {
        ...
        // var e = t.match(this.current);

        // console.log(t.class);
        // if(t.class !== null){
        //   window.customElements.define('template-test', t.class);
        // }
        // this.current_route = e ? e: null;
        if(e!==null) {
